---
description: Synthesize multiple sources (articles, docs, competitor analyses) into one conflict-resolved brief
---
...
Sources (paste all of them inline, separated by `---SOURCE N---` headers):
...
3. **CRITICAL GAPS** — What none of them cover, but is important to fully understand this topic
4. **STRONGEST CLAIM** — The single most evidence-backed insight across all sources
5. **ACTIONABLE TAKEAWAY** — One concrete thing the reader should do or decide based on this
